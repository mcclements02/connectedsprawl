...
from .operator_material import apply_subdivision
...
class POLIIGON_OT_apply(Operator):
    ...
    name_material: StringProperty(options={"HIDDEN"})  # noqa: F821  # type: ignore
    ...
    def execute(self, context):
        ...
        if do_subdiv or len(objs_selected) > len(objs_add_disp):
            if bpy.app.version < (5, 0) and bpy.context.scene.render.engine == "CYCLES":
