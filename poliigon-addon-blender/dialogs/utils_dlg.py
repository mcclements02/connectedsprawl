...
def panel_message_box(
        cTB,
        context: bpy.types.Context,
        layout: bpy.types.UILayout,
        message: str) -> None:
    """Creates a word-wrapped box message for a propery panel."""
    box = layout.box()
    msg = _t(message)
    region_width = context.region.width
    w_label = region_width - 40 * get_ui_scale(cTB)
    wrapped_label(cTB, w_label, msg, box, add_padding=False, add_padding_bottom=False)
