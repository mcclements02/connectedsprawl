...
class c_Toolbox(PoliigonAddon):
    ...
    def register(self, version: str) -> None:
        ...
        self.api_rc.add_job_get_all_assets(
    ...
    def callback_get_user_data_done(self, job: ApiJob) -> None:
        ...
        if not job.result.ok:
            ...
            self.startup_jobs_complete = True  # Still signal completion
            self.refresh_ui()
            return
        ...
        self.startup_jobs_complete = True
        self.refresh_ui()
    ...
    def refresh_data(self, icons_only: bool = False) -> None:
        ...
        self._asset_index.flush(all_assets=True)
