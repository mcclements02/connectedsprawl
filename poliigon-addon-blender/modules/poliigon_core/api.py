...
DOWNLOAD_CHUNK_SIZE = 65536  # 64 KB per chunk for efficient streaming
...
SOFTWARE_NAME_POLYDEX = "polydex"
SOFTWARE_DOWNLOAD_NAME_POLYDEX = "Polydex"
PLATFORM_NAME_POLYDEX = "polydex"
...
class PoliigonConnector():
    ...
    api_url: str
    token: Optional[str] = None  # Populated on login/settings read, cleared sans auth.
    ...
    def __init__(self,
        ...
        elif software == SOFTWARE_NAME_POLYDEX:
            self._platform = PLATFORM_NAME_POLYDEX
            self.software_dl_dcc = SOFTWARE_DOWNLOAD_NAME_POLYDEX
    ...
    def log_out(self) -> ApiResponse:
        ...
        endpoint = "/logout"
        res = self._request_authenticated(endpoint, payload={}, method="POST")
        if res.ok:
            self.token = None
            if "data" in res.body:
    ...
    def get_user_info(self) -> ApiResponse:
        ...
        path = "/me"
        res = self._request_authenticated(path, method="POST")
    ...
    def update_user_profile(self,
        ...
        res = self._request_authenticated(endpoint, payload=payload, method="POST")
        return res
    ...
    def track_download_quality(self,
        ...
        res = self._request_authenticated("/t/download_quality", payload=payload, skip_mp=False)
        if not res.ok:
            self.report_message(
    ...
    def get_recently_viewed_assets(self) -> ApiResponse:
        ...
        res = self._request_authenticated(endpoint, payload=None, method="GET")
    ...
    def get_user_assets(self, recent_downloads: bool = False) -> ApiResponse:
        ...
        if not res.ok:
            ...
            return res
        elif "asset_ids" not in res.body:
            self.report_message(
    ...
    def get_category_assets(self, path_category: str) -> ApiResponse:
        ...
        res = self._request(endpoint, payload=None, method="GET")
        if not res.ok:
            if res.error not in SKIP_REPORT_ERRS:
                self.report_message(
    ...
    def get_asset_details(self, asset_id: int) -> ApiResponse:
        ...
        res = self._request_authenticated(endpoint, method="GET")
        return res
    ...
    def get_user_available_plans(self) -> Optional[ApiResponse]:
        ...
        return self._request_authenticated("/subscriptions/update/plans", method="GET")
    ...
    def get_upgrade_plan(self, plan_id: str) -> ApiResponse:
        ...
        return self._request_authenticated(endpoint, method="GET")
    ...
    def put_upgrade_plan(self, plan_id: str) -> ApiResponse:
        ...
        endpoint = f"/subscriptions/update?item_price_id={plan_id}"
        return self._request_authenticated(endpoint, method="PUT")
    ...
    def resume_paused_plan(self) -> ApiResponse:
        ...
        return self._request_authenticated(
            "/subscription/resume", method="POST")
    ...
    def remove_cancellation_plan(self) -> ApiResponse:
        ...
        return self._request_authenticated(
            "/subscription/remove/cancellation", method="POST")
    ...
    def remove_scheduled_paused_plan(self) -> ApiResponse:
        ...
        return self._request_authenticated(
            "/subscription/remove/pause", method="POST")
    ...
    def _signal_event(self, event_name: str, payload: Dict) -> ApiResponse:
        ...
        return self._request_authenticated(
            endpoint, payload=payload, method="POST")
    ...
    def signal_press_button(
            self,
            button_id: str,
            location: Optional[str] = None) -> ApiResponse:
        """Sends press button event if opted in."""

        payload = {"button_id": button_id}
        if location is not None and isinstance(location, str):
            payload["location"] = location
        return self._signal_event("press_button", payload=payload)
    ...
    def _update_meta_payload(
        ...
        if self._platform == PLATFORM_NAME_POLYDEX:
    ...
    def get_base_url(self, env_name: str = "prod") -> str:
        ...
        url_base = url_base.replace("api", "dev")
        return url_base
    ...
    def get_poliigon_link(self,
        ...
        is_internal = url_path.startswith("/")
        if is_internal:
        ...
        if add_utm_suffix and is_internal:
    ...
    def _load_asset_overrides(self, json_dir: str) -> None:
        ...
        (convention_0) or "AssetID" (convention_1) as a top-level key, or be
        a top-level list of dictionaries where each dictionary contains a
        field for "id" or "AssetID" ie the asset_id.
        """
    ...
    def _extract_assetdata_from_dict(
        ...
        if isinstance(json_data, dict):
            ...
            # Try both convention_1 (AssetID) and convention_0 (id)
            toplevel_id = json_data.get("AssetID")
            if toplevel_id is None:
    ...
    def get_asset_override(self, asset_id: int) -> Optional[Dict]:
        """Get override data for a specific asset ID if it exists."""
        return self._assetdata_overrides.get(asset_id)
