...
from .preferences_map_prefs import add_map_pref_rows, MapPrefProperties
...
class PoliigonPreferences(bpy.types.AddonPreferences):
    ...
    asset_browser_library_name: bpy.props.StringProperty(
        ...
        default="Poliigon Library",  # noqa: F722
    ...
    map_prefs: bpy.props.CollectionProperty(type=MapPrefProperties)  # type: ignore
    ...
    def _draw_additional_dirs_prefs(self) -> None:
        ...
        # Combine + sort dirs so the UI order doesn't update on enable/disable
        disabled_dirs = list(cTB.settings["disabled_dirs"])
        all_dirs = sorted(additional_dirs + disabled_dirs)
    ...
    def _draw_download_prefs_map_prefs(self, box, context) -> None:
        col = box.column()
        ...
        add_map_pref_rows(cTB, col, context)
    ...
    def _draw_download_prefs(self, context) -> None:
        ...
        self._draw_download_prefs_map_prefs(box, context)
